...
export const CASE_STUDIES: CaseStudyItem[] = [
  ...
  },
  {
    ...
    result: 'Functional digital worker prototype capable of resolving 70%+ of standard internal HR questions instantly while logging audit trails.',
  ...
  },
  {
    ...
    result: 'Demonstrated 24/7 patient booking capability with automated confirmation loops and slot conflict resolution.',
  ...
  },
  {
    ...
    result: 'Successfully delivered production e-commerce platform for client operations.',
  ...
  },
  {
    ...
    result: 'Delivered client website driving direct inbound inquiries and local brand recognition.',
...
export const DIFFERENTIATORS: Differentiator[] = [
  ...
  },
  {
    ...
    title: 'South African Context & POPIA Compliant',
    badge: 'Local & Secure',
    description: 'Based in Pretoria with deep understanding of local business realities, multi-channel communication (WhatsApp dominance), and strict POPIA data privacy standards.',
    icon: 'MapPin',
  },
];
...
export const ENGAGEMENT_MODELS: PricingEngagement[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Guaranteed SLA response times (same-day support)',
...
export const FAQ_LIST: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'The eStudy AI Incubation Programme is a prestigious 12-month sponsored cohort based in South Africa that supports high-potential tech founders in engineering enterprise-grade, commercially viable AI systems. Aura Tech Intelligence was founded and developed directly through this incubation.',
  },
];
